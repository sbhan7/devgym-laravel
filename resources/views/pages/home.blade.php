            ...
            <div class="container">
                ...
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
                        ...
                        <!-- Title -->
                        <h1 class="mb-0 display-6">به باشگاه آنلاین {{setting('site.title')}} <br>
                        ...
                        <!-- Content -->
                        <p class="my-4">{{setting('site.home_title')}}</p>


                        <div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
                            <!-- Button -->
                            <a href="{{route('register')}}" class="btn btn-lg btn-danger-soft me-2 mb-4 mb-sm-0">شروع کن 😉</a>
                            <!-- Video button -->
                ...
                <div class="row mb-4">
                    <div class="col-lg-8 mx-auto text-center">
                        <h2 class="fs-3 fw-bold">
                            <span class="position-relative z-index-9">دوره ها و ویدئو های</span>
                            <span class="position-relative z-index-1">تک قسمتی
                                <!-- SVG START -->
                        ...
                        <p class="mb-0">دوره ها و ویدئو های تک قسمتی رو تو این بخش میتونی پیدا کنی.</p>
                    </div>
                </div>
                                ...
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <div class="d-flex justify-content-between mb-2">
                                            <a href="#" class="badge bg-purple bg-opacity-10 text-purple">{{config('enum.course')[$course->level]}}</a>
                                        ...
                                        <p class="mb-2 text-truncate-2">{!! $course->description_short !!}</p>
                                    ...
                                    <div class="card-footer pt-0 pb-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <span class="h6 fw-light mb-0"><i class="far fa-clock text-danger me-2"></i>{{$course->video_time}}ساعت </span>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <p class="text-truncate-2 mb-2">با تولید سادگی نامفهوم از صنعت چاپ و با استفاده
                                            از طراحان گرافیک</p>
                                        <!-- Rating star -->
                            ...
                            <div class="row justify-content-center position-relative">
                                ...
                                <div class="col-11 position-relative">
                                    <div class="row align-items-center">
                                        <!-- Title -->
                                        <div class="col-lg-7">
                                            <h2 class="text-white mb-0 h3">اولین ثبت نام تو یه باشگاه مجازی رو انجام بده</h2>
                                                <p class="text-white small">دانش خودت رو تقویت کن، مهارت خودت رو با من زیاد کن.</p>
                                        </div>
                                        <!-- Content and input -->
                                        <div class="col-lg-5 text-lg-end mt-3 mt-lg-0">
                                            <a href="{{route('register')}}" class="btn btn-warning mb-0">ثبت نام رایگان</a>
                                        </div>
                                    </div> <!-- Row END -->
                                </div>
                            </div>
