                    ...
                    <div class="col-12">
                        <div class="video-player rounded-3">
                            <video controls crossorigin="anonymous" playsinline
                                   poster="{{voyager::image($course_video->image)}}">
                                <source src="{{$lesson_video->video_url ?? ''}}" type="video/mp4"
                                        size="1080">
                ...
                <div class="row g-lg-5">
                    ...
                    <div class="col-lg-8">
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <!-- Title -->
                                <h1 class="fs-3">{{$course_video->title}}</h1>
                                <!-- Content -->
                                <ul class="list-inline mb-0">
                                    ...
                                    <li class="list-inline-item h6 me-3 mb-1 mb-sm-0"><i
                                            class="fas fa-signal text-success me-2"></i>{{config('enum.course')[$course_video->level]}}
                                    </li>
                                </ul>
                            </div>
                            <!-- Course title END -->
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="avatar avatar-lg">
                                            <img class="avatar-img rounded-circle"
                                                 src="{{voyager::image($course_video->teacher->avatar)}}"
                                                 alt="avatar">
                                        </div>
                                        <div class="ms-3">
                                            <h6 class="mb-0"><a href="#">{{$course_video->teacher->name}}</a></h6>
                                ...
                                <div class="tab-content pt-4 px-3" id="course-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="course-pills-1" role="tabpanel"
                                        ...
                                        <p class="mb-3">به مجموعه ی آموزشی <strong>
                                                {{$course_video->title}}</strong> خوش آمدید.</p>
                                        <p class="mb-3">{!! $course_video->description_short !!}</p>
                                        <p class="mb-3">{!! $course_video->description_long !!}</p>
                                            ...
                                            <h6 class="accordion-header font-base" id="heading-1">
                                                <a class="accordion-button fw-bold rounded collapsed d-block"
                                                   ...
                                                   aria-controls="collapse-1">
                                                    <span class="mb-0">{{$course_video->title}}</span>
                                                    <span
                                                        class="small d-block mt-1">({{$course_video->video_count}} ویدیو)</span>
                                                </a>
                                            </h6>
                                            <div id="collapse-1" class="accordion-collapse collapse show"
                                                ...
                                                <div class="accordion-body mt-3">
                                                    <div class="vstack gap-3">
                                                        <!-- Course lecture -->
                                                        @foreach($course_video->lesson as $lesson)
                                                            <div
                                                                class="d-flex justify-content-between align-items-center">
                                                                <div
                                                                    class="position-relative d-flex align-items-center">
                                                                    <a href="{{route('course_video', [  $course_video->slug, $lesson->id ])}}"
